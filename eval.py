...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate multimodal sentiment model on a labeled file")
    parser.add_argument("--data_dir", type=str, default="data")
    parser.add_argument("--data_file", type=str, default="dev.txt", help="Labeled data file to evaluate, default dev.txt")
